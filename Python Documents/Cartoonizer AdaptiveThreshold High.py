...
os.chdir("D:/User/Salvarki/Desktop/Test/DatasetVoltiFumettatiAdaptiveThresholdHighETA/valid/images")            # cartella di destinazione dei trasformati
...
while i < len(file):
    ...
    edges = cv2.adaptiveThreshold(gray, 255, cv2.ADAPTIVE_THRESH_MEAN_C, cv2.THRESH_BINARY, 27, 7)  # scelta blockSize e costante C: (7, 4) (11, 2) (9, 9) (5, 3)  provato da me (3,2) (27,7) (5,3)

    color = cv2.bilateralFilter(img, 12, 250, 250)        # scelta sigma parametri: 250,250
